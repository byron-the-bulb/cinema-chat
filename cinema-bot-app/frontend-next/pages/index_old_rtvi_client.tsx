  ...
  useEffect(() => {
    ...
    const pollInterval = setInterval(async () => {
      try {
        ...
        const url = `${cleanBaseUrl}/conversation-status/${sessionIdentifier}`;
        ...
        // Also check for display_messages (reasoning, video selections)
        if (data.context && data.context.display_messages) {
          data.context.display_messages.forEach((msg: any) => {
            addChatMessage(msg, 'system');
          });
          // Clear display messages after showing them once
